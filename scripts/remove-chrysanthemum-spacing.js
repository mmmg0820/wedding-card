...
const before = `aria-label="고인">❀</span> 권오필`;
const after = `aria-label="고인">❀</span>권오필`;
const count = html.split(before).length - 1;
if (count !== 1) throw new Error(`Chrysanthemum spacing: expected once, found ${count}`);
...
console.log('Removed spacing after the chrysanthemum mark.');
